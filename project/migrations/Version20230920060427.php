...
final class Version20230920060427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, about_service_id INT DEFAULT NULL, parent_service_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, expertise LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', is_active TINYINT(1) NOT NULL, INDEX IDX_E19D9AD22E640580 (about_service_id), INDEX IDX_E19D9AD2AA1F2DB6 (parent_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
